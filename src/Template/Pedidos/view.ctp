...
<div class="pedidos view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $pedido->has('platillo') ? $this->Html->link($pedido->platillo->id, ['controller' => 'Platillos', 'action' => 'view', $pedido->platillo->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($pedido->subtotal) ?></td>
        </tr>
        <tr>
